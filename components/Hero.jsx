  ...
  return (
    <div className="pb-20 px-4 container mx-auto">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Finory is an AI-powered financial management tool that helps you track, manage, and analyze your expenses with ease.</p>
