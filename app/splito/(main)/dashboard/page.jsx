...
const SplitoDashboard = () => {
  ...
  const isLoading = balancesLoading || totalSpentLoading || monthlySpendingLoading || groupsLoading;
              ...
              <Card>
                ...
                <CardFooter>
                  <Button variant="outline" asChild className="w-full">
                    <Link href="/splito/contacts?createGroup=true">
...
export default SplitoDashboard
